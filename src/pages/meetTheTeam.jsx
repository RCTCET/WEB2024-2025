...
const teamMembers = [
    ...
    // 2023-2024
    { id: 35, name: 'Rtr. Amar Singh', role: 'President', image: '/team/2023-2024/Rtr.Amar SIngh- President_27_IMGCentury.avif', year: '2023-2024' },
    { id: 58, name: 'Rtr. Sumit Sharma', role: 'Secretary', image: '/team/2023-2024/Rtr.Sumit Sharma- Secretary_14_IMGCentury.avif', year: '2023-2024' },
    { id: 48, name: 'Rtr. Muskan Sinha', role: 'Immediate Past President', image: '/team/2023-2024/Rtr.Muskan Sinha- Immediate past President_6_IMGCentury.avif', year: '2023-2024' },
    { id: 34, name: 'Rtr. Akshay Sharma', role: 'Vice President Main Avenue', image: '/team/2023-2024/Rtr.Akshay Sharma- Vice President main Avenue_26_IMGCentury.avif', year: '2023-2024' },
    { id: 55, name: 'Rtr. Shah Alam Khan', role: 'Vice President Support Function', image: '/team/2023-2024/Rtr.Shah Alam Khan- Vice President Support function_12_IMGCentury.avif', year: '2023-2024' },
    { id: 43, name: 'Rtr. Esha Mehra', role: 'Chairperson Finance', image: '/team/2023-2024/Rtr.Esha Mehra- chairperson finance_1_IMGCentury.avif', year: '2023-2024' },
    { id: 38, name: 'Rtr. Arudra sahib', role: 'Human resource development officer', image: '/team/2023-2024/Rtr.Arudra sahib- Human resource development officer_30_IMGCentury.avif', year: '2023-2024' },
    { id: 42, name: 'Rtr. Disha Rathod', role: 'Jt. Secretary', image: '/team/2023-2024/Rtr.Disha Rathod- Jt. Secretary _34_IMGCentury.avif', year: '2023-2024' },
    { id: 60, name: 'Rtr. Tanisha Kumar', role: 'Jt. Secretary and chairperson publications', image: '/team/2023-2024/Rtr.Tanisha Kumar- Jt. Secretary and chairperson publications_15_IMGCentury.avif', year: '2023-2024' },
    //2022-2023
...
const boardOfDirectors = [
    //2024-2025
    { id: 1, name: 'Rtr. Shreya Jadhav', role: 'Club Service', image: '/team/2024-2025/Rtr. Shreya Jadhav.webp', year: '2024-2025' },
    { id: 2, name: 'Rtr. Dhairya Doshi', role: 'Club Service', image: '/team/2024-2025/Rtr. Dhairya Doshi.webp', year: '2024-2025' },
    { id: 3, name: 'Rtr. Aaryan Gupta', role: 'Community Service', image: '/team/2024-2025/Rtr. Aaryan Gupta.webp', year: '2024-2025' },
    { id: 4, name: 'Rtr. Suryansh Rai', role: 'Community Service', image: '/team/2024-2025/Rtr. Suryansh Rai.webp', year: '2024-2025' },
    { id: 5, name: 'Rtr. Anushka Thakur', role: 'Community Service', image: '/team/2024-2025/Rtr. Anushka Thakur.webp', year: '2024-2025' },
    { id: 6, name: 'Rtr. Jaidan Maity', role: 'Professional Development', image: '/team/2024-2025/Rtr. Jaidan Maity.webp', year: '2024-2025' },
    { id: 7, name: 'Rtr. Vaishnavi Ranjan', role: 'Professional Development', image: '/team/2024-2025/Rtr. Vaishnavi Ranjan.webp', year: '2024-2025' },
    { id: 8, name: 'Rtr. Rashi Bedse', role: 'International Service', image: '/team/2024-2025/Rtr. Rashi Bedse.webp', year: '2024-2025' },
    { id: 9, name: 'Rtr. Shweta Varma', role: 'International Service', image: '/team/2024-2025/Rtr. Shweta Varma.webp', year: '2024-2025' },
    { id: 10, name: 'Rtr. Vivek Rai', role: 'Shiksha', image: '/team/2024-2025/Rtr. Vivek Rai.webp', year: '2024-2025' },
    { id: 11, name: 'Rtr. Palak Upadhyay', role: 'Shiksha', image: '/team/2024-2025/Rtr. Palak Upadhyay.webp', year: '2024-2025' },
    { id: 12, name: 'Rtr. Ayaan Shaikh', role: 'Sports', image: '/team/2024-2025/Rtr. Ayaan Shaikh.webp', year: '2024-2025' },
    { id: 13, name: 'Rtr. Fuzail Khan', role: 'Sports', image: '/team/2024-2025/Rtr. Fuzail Khan.webp', year: '2024-2025' },
    { id: 14, name: 'Rtr. Kriti Saxena', role: 'Entrepreneurship Development', image: '/team/2024-2025/Rtr. Kriti Saxena.webp', year: '2024-2025' },
    { id: 15, name: 'Rtr. Atharva Nayak', role: 'Entrepreneurship Development', image: '/team/2024-2025/Rtr. Atharva Nayak.webp', year: '2024-2025' },
    { id: 16, name: 'Rtr. Ansh Mishra', role: 'Social Media and Relation', image: '/team/2024-2025/Rtr. Ansh Mishra.webp', year: '2024-2025' },
    { id: 17, name: 'Rtr. Jai Anjaria', role: 'Social Media and Relation', image: '/team/2024-2025/Rtr. Jai Anjaria.webp', year: '2024-2025' },
    { id: 18, name: 'Rtr. Srishti Srivastava', role: 'Social Media and Relation', image: '/team/2024-2025/Rtr. Srishti Srivastava.webp', year: '2024-2025' },
    { id: 19, name: 'Rtr. Pranjal Chavan', role: 'Digital Communication', image: '/team/2024-2025/Rtr. Pranjal Chavan.webp', year: '2024-2025' },
    { id: 20, name: 'Rtr. Janhvi Kushwaha', role: 'Digital Communication', image: '/team/2024-2025/Rtr. Janhvi Kushwaha.webp', year: '2024-2025' },
    { id: 21, name: 'Rtr. Krish Agrawal', role: 'Digital Communication', image: '/team/2024-2025/Rtr. Krish Agrawal.webp', year: '2024-2025' },
    { id: 22, name: 'Rtr. Reeba Diwan', role: 'Editorial', image: '/team/2024-2025/Rtr. Reeba Diwan.webp', year: '2024-2025' },
    { id: 23, name: 'Rtr. Rudra Sharma', role: 'Editorial', image: '/team/2024-2025/Rtr. Rudra Sharma.webp', year: '2024-2025' },
    { id: 24, name: 'Rtr. Chandranshu Dharmik', role: 'Partner-in-Service', image: '/team/2024-2025/Rtr. Chandranshu Dharmik.webp', year: '2024-2025' },
    { id: 25, name: 'Rtr. Farhan Shaikh', role: 'Public Relation', image: '/team/2024-2025/Rtr. Farhan Shaikh.webp', year: '2024-2025' },
    { id: 26, name: 'Rtr. Jeneesh Joshi', role: 'Public Relation', image: '/team/2024-2025/Rtr. Jeenesh Joshi.webp', year: '2024-2025' },
    { id: 27, name: 'Rtr. Shivangi Pandey', role: 'Public Relation', image: '/team/2024-2025/Rtr. Shivangi Pandey.webp', year: '2024-2025' },
    { id: 28, name: 'Rtr. Utsav Yadav', role: 'Marketing', image: '/team/2024-2025/Rtr. Utsav Yadav.webp', year: '2024-2025' },
    { id: 29, name: 'Rtr. Sakshi Singh', role: 'Marketing', image: '/team/2024-2025/Rtr. Sakshi Singh.webp', year: '2024-2025' },

    //2023-24
    { id: 49, name: 'Rtr. Neeharika Jha', role: 'Jt. Shiksha director', image: '/team/2023-2024/Rtr. Neeharika Jha- Jt. Shiksha director_19_IMGCentury.avif', year: '2023-2024' },
    { id: 44, name: 'Rtr. Gaurav Warke', role: 'Sports Director', image: '/team/2023-2024/Rtr.Gaurav Warke- Sports Director_2_IMGCentury.avif', year: '2023-2024' },
    { id: 56, name: 'Rtr. Shreya Pandey', role: 'club service director', image: '/team/2023-2024/Rtr. Shreya Pandey- club service director_20_IMGCentury.avif', year: '2023-2024' },
    { id: 45, name: 'Rtr. Himanshu Jangid', role: 'Jt. Digital communication director', image: '/team/2023-2024/Rtr.Himanshu Jangid - Jt. Digital communication director_3_IMGCentury.avif', year: '2023-2024' },
    { id: 57, name: 'Rtr. Swati Singh', role: 'Jt. Community service director', image: '/team/2023-2024/Rtr. Swati Singh- Jt. Community service director_21_IMGCentury.avif', year: '2023-2024' },
    { id: 46, name: 'Rtr. Labdhi doshi', role: 'Entrepreneurship development director', image: '/team/2023-2024/Rtr.Labdhi doshi- Entrepreneurship development director_4_IMGCentury.avif', year: '2023-2024' },
    { id: 30, name: 'Rtr. Abhishek Yadav', role: 'Shiksha director', image: '/team/2023-2024/Rtr.Abhishek Yadav- Shiksha director_22_IMGCentury.avif', year: '2023-2024' },
    { id: 47, name: 'Rtr. Mukesh Kadali', role: 'smr & media production director', image: '/team/2023-2024/Rtr.Mukesh Kadali- smr & media production director_5_IMGCentury.avif', year: '2023-2024' },
    { id: 31, name: 'Rtr. Aditi Pandey', role: 'Jt. Community service director', image: '/team/2023-2024/Rtr.Aditi Pandey - Jt. Community service director_23_IMGCentury.avif', year: '2023-2024' },
    { id: 32, name: 'Rtr. Aditya Rajbhar', role: 'Smr director', image: '/team/2023-2024/Rtr.Aditya Rajbhar - Smr director_24_IMGCentury.avif', year: '2023-2024' },
    { id: 33, name: 'Rtr. Aizab Khan', role: 'public relations and marketing director', image: '/team/2023-2024/Rtr.Aizab Khan- public relations and marketing director_25_IMGCentury.avif', year: '2023-2024' },
    { id: 51, name: 'Rtr. Riddhi Joshi', role: 'Jt. Professional development director', image: '/team/2023-2024/Rtr.Riddhi Joshi- Jt. Professional development director_8_IMGCentury.avif', year: '2023-2024' },
    { id: 52, name: 'Rtr. Samyak Waghmare', role: 'Jt. Public relations and marketing director', image: '/team/2023-2024/Rtr.Samyak Waghmare- Jt. Public relations and marketing director_9_IMGCentury.avif', year: '2023-2024' },
    { id: 53, name: 'Rtr. Saumya mishra', role: 'Digital communication director', image: '/team/2023-2024/Rtr.Saumya mishra- Digital communication director_10_IMGCentury.avif', year: '2023-2024' },
    { id: 36, name: 'Rtr. Anjali Patel', role: 'Jt. Public relations and marketing director', image: '/team/2023-2024/Rtr.Anjali Patel- Jt. Public relations and marketing director_28_IMGCentury.avif', year: '2023-2024' },
    { id: 37, name: 'Rtr. Anshul Khadatkar', role: 'professional development director', image: '/team/2023-2024/Rtr.Anshul Khadatkar- professional development director_29_IMGCentury.avif', year: '2023-2024' },
    { id: 57, name: 'Rtr. Soham Shinde', role: 'Sports Director', image: '/team/2023-2024/Rtr.Soham Shinde- Sports Director_13_IMGCentury.avif', year: '2023-2024' },
    { id: 59, name: 'Rtr. Tushar Mishra', role: 'Community service director', image: '/team/2023-2024/Rtr.Tushar Mishra- Community service director_16_IMGCentury.avif', year: '2023-2024' },
    { id: 61, name: 'Rtr. Vartika upadhyay', role: 'Editorial service director', image: '/team/2023-2024/Rtr.Vartika upadhyay- Editorial service director_17_IMGCentury.avif', year: '2023-2024' },
    { id: 62, name: 'Rtr. Yuvraj Desai', role: 'jt. Club service and jt. International service director', image: '/team/2023-2024/Rtr.Yuvraj Desai- jt. Club service and jt. International service director_18_IMGCentury.avif', year: '2023-2024' },
    { id: 50, name: 'Rtr. Prabhat Maurya', role: 'Editorial director', image: '/team/2023-2024/Rtr.Prabhat Maurya - Editorial director_7_IMGCentury.avif', year: '2023-2024' },
    { id: 39, name: 'Rtr. Atulya Sawant', role: 'Jt. Smr director', image: '/team/2023-2024/Rtr.Atulya Sawant- Jt. Smr director_31_IMGCentury.avif', year: '2023-2024' },
    { id: 40, name: 'Rtr. Bhargav Nadiyana', role: 'partner in service director', image: '/team/2023-2024/Rtr.Bhargav Nadiyana- partner in service director_32_IMGCentury.avif', year: '2023-2024' },
