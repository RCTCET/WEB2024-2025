...
const teamMembers = [
    // 2024-2025
    { id: 1, name: 'Rtr. Tanisha Kumar', role: 'President', image: '/team/2024-2025/Rtr. Tanisha Kumar-President.avif', year: '2024-2025' },
    { id: 2, name: 'Rtr. Prabhat Maurya', role: 'Secretary', image: '/team/2024-2025/Rtr. Prabhat Maurya-Secretary.avif', year: '2024-2025' },
    { id: 3, name: 'Rtr. Amar Singh', role: 'Immediate Past President', image: '/team/2024-2025/Rtr. Amar Singh Immediate Past President_.avif', year: '2024-2025' },
    { id: 4, name: 'Rtr. Aizab Khan', role: 'Vice President', image: '/team/2024-2025/Rtr. Aizab Khan-Vice President_.avif', year: '2024-2025' },
    { id: 5, name: 'Rtr. Tushar Mishra', role: 'Vice President', image: '/team/2024-2025/Rtr. Tushar Mishra-Vice President_.avif', year: '2024-2025' },
    { id: 6, name: 'Rtr. Sudiksha Kapoor', role: 'Vice President', image: '/team/2024-2025/Rtr. Sudiksha Kapoor -Vice President_.avif', year: '2024-2025' },
    { id: 7, name: 'Rtr. Disha Rathod', role: 'Chairperson Finance', image: '/team/2024-2025/Rtr. Disha Rathod- Chairperson Finance_.avif', year: '2024-2025' },
    { id: 8, name: 'Rtr. Tanisha Sawalkar', role: 'Sergeant At Arms', image: '/team/2024-2025/Rtr. Tanisha Sawalkar- Sergeant At Arms.avif', year: '2024-2025' },
    { id: 9, name: 'Rtr. Saumya Mishra', role: 'Chairperson Human Resource Development', image: '/team/2024-2025/Rtr. Saumya Mishra- Chairperson - Human Resource Development.avif', year: '2024-2025' },
    { id: 10, name: 'Rtr. Aniska Bachar', role: 'Joint Secretary', image: '/team/2024-2025/Rtr. Aniska Bachar - Joint Secretary.avif', year: '2024-2025' },
    { id: 11, name: 'Rtr. Aaditya Yadav', role: 'Joint Secretary', image: '/team/2024-2025/Rtr. Aaditya Yadav - Joint Secretary.avif', year: '2024-2025' },
    { id: 12, name: 'Rtr. Yohaan Khan', role: 'Chairperson Publications', image: '/team/2024-2025/Rtr. Yohaan Khan - Chairperson Publications.avif', year: '2024-2025' },
    // 2023-2024    
...
const boardOfDirectors = [
    { id: 1, name: 'Rtr. Shreya Jadhav', role: 'Club Service', image: '/team/2024-2025/Rtr. Shreya Jadhav -Club Service Director_.avif', year: '2024-2025' },
    { id: 2, name: 'Rtr. Dhairya Doshi', role: 'Club Service', image: '/team/2024-2025/Rtr. Dhairya Doshi-Club Service Director.avif', year: '2024-2025' },
    { id: 3, name: 'Rtr. Aaryan Gupta', role: 'Community Service', image: '/team/2024-2025/Rtr. Aaryan Gupta Community Service Director_.avif', year: '2024-2025' },
    { id: 4, name: 'Rtr. Suryansh Rai', role: 'Community Service', image: '/team/2024-2025/Rtr. Suryansh Rai - Community Service Director_.avif', year: '2024-2025' },
    { id: 5, name: 'Rtr. Anushka Thakur', role: 'Community Service', image: '/team/2024-2025/Rtr. Anushka Thakur- Community Service Director_.avif', year: '2024-2025' },
    { id: 6, name: 'Rtr. Jaidan Maity', role: 'Professional Development', image: '/team/2024-2025/Rtr. Jaidan Maity-Professional Development Director.avif', year: '2024-2025' },
    { id: 7, name: 'Rtr. Vaishnavi Ranjan', role: 'Professional Development', image: '/team/2024-2025/Rtr. Vaishnavi Ranjan- Board of Directors -Professional Development.avif', year: '2024-2025' },
    { id: 8, name: 'Rtr. Rashi Bedse', role: 'International Service', image: '/team/2024-2025/Rtr. Rashi Bedse- International Service Director_.avif', year: '2024-2025' },
    { id: 9, name: 'Rtr. Shweta Varma', role: 'International Service', image: '/team/2024-2025/Rtr. Shweta Varma - International Service Director_.avif', year: '2024-2025' },
    { id: 10, name: 'Rtr. Vivek Rai', role: 'Shiksha', image: '/team/2024-2025/Rtr. Vivek Rai- Board of Directors, Shiksha.avif', year: '2024-2025' },
    { id: 11, name: 'Rtr. Palak Upadhyay', role: 'Shiksha', image: '/team/2024-2025/Rtr. Palak Upadhyayi- Board of Directors, Shiksha.avif', year: '2024-2025' },
    { id: 12, name: 'Rtr. Ayaan Shaikh', role: 'Sports', image: '/team/2024-2025/Rtr. Ayaan Shaikh -Sports Director_.avif', year: '2024-2025' },
    { id: 13, name: 'Rtr. Fuzail Khan', role: 'Sports', image: '/team/2024-2025/Rtr. Fuzail Khan - Sports Director.avif', year: '2024-2025' },
    { id: 14, name: 'Rtr. Kriti Saxena', role: 'Entrepreneurship Development', image: '/team/2024-2025/Rtr. Kriti Saxena-Board of Director, Entrepreneurship Development .avif', year: '2024-2025' },
    { id: 15, name: 'Rtr. Atharva Nayak', role: 'Entrepreneurship Development', image: '/team/2024-2025/Rtr. Atharva Nayak- Board of Director ,Entrepreneurship Development.avif', year: '2024-2025' },
    { id: 16, name: 'Rtr. Ansh Mishra', role: 'Social Media and Relation', image: '/team/2024-2025/Rtr. Ansh Mishra - Social Media Relations Director_.avif', year: '2024-2025' },
    { id: 17, name: 'Rtr. Jai Anjaria', role: 'Social Media and Relation', image: '/team/2024-2025/Rtr. Jai Anjaria- Social Media Relations Director_.avif', year: '2024-2025' },
    { id: 18, name: 'Rtr. Srishti Srivastava', role: 'Social Media and Relation', image: '/team/2024-2025/Rtr. Srishti Srivastava -Social Media Relations Director_.avif', year: '2024-2025' },
    { id: 19, name: 'Rtr. Pranjal Chavan', role: 'Digital Communication', image: '/team/2024-2025/Rtr. Pranjal Chavan - Digital Communication Director_.avif', year: '2024-2025' },
    { id: 20, name: 'Rtr. Janhvi Kushwaha', role: 'Digital Communication', image: '/team/2024-2025/Rtr. Janhvi Kushwaha- Board of Director, Digital Communication.avif', year: '2024-2025' },
    { id: 21, name: 'Rtr. Krish Agrawal', role: 'Digital Communication', image: '/team/2024-2025/Rtr. Krish Agarwal-Digital Communication Director.avif', year: '2024-2025' },
    { id: 22, name: 'Rtr. Reeba Diwan', role: 'Editorial', image: '/team/2024-2025/Editorial Service Board of Directors.avif', year: '2024-2025' },
    { id: 23, name: 'Rtr. Rudra Sharma', role: 'Editorial', image: '/team/2024-2025/Rtr. Rudra Sharma- Board of Director ,Editorials.avif', year: '2024-2025' },
    { id: 24, name: 'Rtr. Chandranshu Dharmik', role: 'Partner-in-Service', image: '/team/2024-2025/Rtr. Chandranshu Dharmik - Partner In Service Director_.avif', year: '2024-2025' },
    { id: 25, name: 'Rtr. Farhan Shaikh', role: 'Public Relation', image: '/team/2024-2025/Rtr. Farhan Shaikh- Board of Director, Public Relations .avif', year: '2024-2025' },
    { id: 26, name: 'Rtr. Jeneesh Joshi', role: 'Public Relation', image: '/team/2024-2025/Rtr. Jeenesh Joshi- Board of Directors, Public Relations .avif', year: '2024-2025' },
    { id: 27, name: 'Rtr. Shivangi Pandey', role: 'Public Relation', image: '/team/2024-2025/Rtr. Shivangi Pandey-Board of Directors, Public Relations .avif', year: '2024-2025' },
    { id: 28, name: 'Rtr. Utsav Yadav', role: 'Marketing', image: '/team/2024-2025/Rtr. Utsav Yadav- Board of Director, Marketing.avif', year: '2024-2025' },
    { id: 29, name: 'Rtr. Sakshi Singh', role: 'Marketing', image: '/team/2024-2025/Rtr. Sakshi Singh- Board of Director, Marketing.avif', year: '2024-2025' },
