...
function HealthText() {
    return(
        <div className="md:w-[528px] xl:w-full mt-10 mx-10 mb-8 lg:mt-16 lg:mb-12 xl:ml-24">
            <img src="/HobbyClub_svg/WELCOME TO HEALTH CLUB.svg" alt="Welcome to HEALTH CLUB" loading="lazy" />
        </div>
    )
}
...
function HealthClubIntro() {
    ...
    <div className="lg:w-screen md:w-screen md:p-0 relative xl:pt-4 xxl:pt-16">
        <div className="w-screen absolute -z-10 md:top-[-14px] lg:top-[-22px]"><img src="/HobbyClub_svg/Frame.svg" alt="bgFrame" className="w-screen object-cover" loading="lazy"/></div>
            <div className="md:px-7 md:flex md:justify-center p-4 md:w-screen">
                <img src="/HobbyClub_svg/Head Logo.svg" alt="HeadLogo" className="lg:w-1/2 xl:w-1/2 xxl:w-1/3 w-full md:w-1/3 md:mb-0 mb-3 xl:ml-14 xl:mr-8" loading="lazy"/>
...
function InitiativeText() {
    return(
        <div className="flex justify-center items-center mt-12 mb-8 lg:mt-20 xl:my-24 xxl:my-36 xxl:mt-44">
            <img src="/HobbyClub_svg/OUR INITIATIVES.svg" alt="Initiative" className="xl:w-[367px] md:w-[300px] w-[200px]" loading="lazy"/>
        </div>
    )
}
